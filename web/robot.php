...
<fieldset>
    ...
    <button type="button" onclick="reset()">更改</button>
    <p>
    ...
    <p>
    初始地址 <input id="init_url" value="" style="width:650px">
...
<fieldset>
    ...
    <p>
        <textarea style="width:100%" disabled rows="5">
restart();
retry();
start(1);start(0);
testTask();
    ...
    <p>
        <textarea style="width:100%" placeholder="暂存文本"></textarea>
    <p>间隔毫秒 <input id="millisec" name="interval" value="<?=($millisec ?? null) ? : 900000?>" style="width:200px">
...
<p>
    最后地址 <input type="text" name="" value="<?=$last ?? null?>" id="gc_url_last" style="width:650px" disabled>
</p>
<p>
